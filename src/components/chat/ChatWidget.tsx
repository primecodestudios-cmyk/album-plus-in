...
const quickTemplates = [
  { icon: BookOpen, label: "Album Demo", prompt: "Show me a demo of Alplum Plus features and how to create a wedding album step by step" },
  { icon: IndianRupee, label: "Pricing Plans", prompt: "What are the pricing plans available for Alplum Plus? Show all plans with prices" },
  ...
  { icon: Download, label: "Download & Install", prompt: "How do I download and install Alplum Plus? What are the system requirements?" },
  { icon: Shield, label: "License & Activation", prompt: "How do I activate my license key? Can I transfer it to another device?" },
  { icon: HelpCircle, label: "Troubleshooting", prompt: "Alplum Plus is running slow or showing errors. How can I fix common issues?" },
  { icon: Sparkles, label: "Smart Features", prompt: "What are the smart automation features in Alplum Plus? Tell me about PSD conversion and templates" },
  { icon: MessageCircle, label: "Refund Policy", prompt: "What is the refund policy for Alplum Plus? Can I get a refund after purchase?" },
];
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-0 right-0 md:bottom-4 md:right-4 z-50 w-full md:w-[380px] md:max-w-[calc(100vw-2rem)] h-[100dvh] md:h-[560px] md:max-h-[calc(100vh-2rem)] bg-card border border-border md:rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-accent/5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Alplum Plus Support</p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-2">
                    ...
                    <div className="bg-muted rounded-2xl rounded-tl-sm px-3 py-2 text-sm text-foreground">
                      👋 Hi! I'm <strong>Alplum Plus AI Assistant</strong>. How can I help you today? Pick a topic below or type your question!
                    </div>
                  </div>
