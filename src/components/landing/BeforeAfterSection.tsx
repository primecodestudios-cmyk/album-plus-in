...
const comparisons = [
  {
    ...
    description: "Manual 6-hour layout vs Alplum Plus 20-minute auto-design",
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-xl mx-auto">
            Compare manual album designing vs Alplum Plus automated workflow.
          </p>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="bg-card rounded-2xl border border-border p-6 shadow-card">
              <div className="text-xs font-bold text-destructive uppercase tracking-wider mb-4">❌ Without Alplum Plus</div>
            ...
            <div className="bg-card rounded-2xl border border-accent/30 p-6 shadow-gold">
              <div className="text-xs font-bold text-accent uppercase tracking-wider mb-4">✅ With Alplum Plus</div>
