        ...
        >
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Download the <strong className="text-foreground">Free Demo</strong> and try FX MinuteAlbum with no commitment. Plus get a special discount on your first purchase!
            </p>
