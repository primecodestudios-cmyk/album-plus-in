...
export interface PsdTemplate {
  id: string;
  name: string;
  category: Exclude<PsdCategory, "All">;
  image: string;
  price: number;
  isFree: boolean;
  fileSize: string;
...
export const templates: PsdTemplate[] = [
  {
    id: "w1",
    name: "Royal Wedding Gold Frame",
    category: "Wedding",
    image: psdWedding1,
    price: 0,
    isFree: true,
    fileSize: "85 MB",
    photoshopVersion: "CS6 — CC 2024",
    pages: 12,
    downloads: 4520,
  },
  {
    id: "w2",
    name: "Purple Elegance Spread",
    category: "Wedding",
    image: psdWedding2,
    price: 199,
    isFree: false,
    fileSize: "120 MB",
    photoshopVersion: "CS5 — CC 2024",
    pages: 18,
    downloads: 3210,
  },
  {
    id: "e1",
    name: "Pink Rose Engagement",
    category: "Engagement",
    image: psdEngagement1,
    price: 149,
    isFree: false,
    fileSize: "65 MB",
    photoshopVersion: "CS6 — CC 2024",
  ...
  {
    id: "b1",
    name: "Birthday Bash Colorful",
    category: "Birthday",
    image: psdBirthday1,
    price: 0,
    isFree: true,
    fileSize: "55 MB",
    photoshopVersion: "CS3 — CC 2024",
    pages: 6,
    downloads: 5100,
  },
  {
    id: "bs1",
    name: "Cute Baby Stars",
    category: "Baby Shoot",
    image: psdBaby1,
    price: 99,
    isFree: false,
  ...
  {
    id: "e2",
    name: "Romantic Engagement Blush",
    category: "Engagement",
    image: psdEngagement1,
    price: 0,
    isFree: true,
  ...
  {
    id: "t2",
    name: "Heritage Traditional Album",
    category: "Traditional",
    image: psdTraditional1,
    price: 199,
    isFree: false,
