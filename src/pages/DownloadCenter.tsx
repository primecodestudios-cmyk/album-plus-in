...
const sections: { title: string; description: string; icon: typeof Download; items: DownloadItem[] }[] = [
  {
    ...
    description: "Download the latest FX MinuteAlbum installer",
    icon: Monitor,
    items: [
      {
        title: "FX MinuteAlbum Full Setup (64-bit)",
      ...
      {
        title: "FX MinuteAlbum Full Setup (32-bit)",
      ...
      {
        title: "FX MinuteAlbum Demo",
        description: "Try FX MinuteAlbum free with limited features. No license required.",
        version: "v5.2.1",
        size: "180 MB",
        date: "March 2026",
        icon: Monitor,
  ...
  },
  {
    ...
    description: "Extend FX MinuteAlbum with powerful plugins",
    icon: Puzzle,
    items: [
      {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-3">
              Download <span className="text-gradient-gold">FX MinuteAlbum</span>
            </h1>
