    ...
    <main className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="bg-destructive/5 border border-destructive/20 rounded-2xl p-5 mb-8 flex gap-4 items-start">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Because Alplum Plus is a <strong className="text-foreground">Digital Product</strong>, refunds are not available after purchase. Once a license key has been generated and delivered, the sale is considered final.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        <section>
          ...
          <p>Alplum Plus is a digital software product delivered electronically. Due to the nature of digital goods, we are unable to process refunds once a license key has been issued and delivered to your account. By completing your purchase, you acknowledge and agree to this no-refund policy.</p>
        </section>
        ...
        <section>
          ...
          <p>We strongly recommend downloading and testing the <strong className="text-foreground">free demo version</strong> of Alplum Plus before making a purchase. The demo includes limited features that allow you to evaluate the software's compatibility with your system and workflow.</p>
        </section>
        ...
        <section>
          ...
          <p>If you have any billing issues or questions about your purchase, reach out to our support team via WhatsApp or through the contact options on our website. We are happy to assist with technical issues to ensure you get the most out of Alplum Plus.</p>
        </section>
      </div>
    </main>
  </div>
