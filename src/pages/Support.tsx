...
const faqs = [
  {
    category: "General",
    questions: [
      { q: "What is Alplum Plus?", a: "Alplum Plus is India's #1 wedding album designing software. It helps photographers create stunning photo albums using smart automation tools, PSD template conversion, and 500+ templates — all compatible with Adobe Photoshop CS3 to CC 2026." },
      { q: "Is Alplum Plus compatible with my Photoshop version?", a: "Yes! Alplum Plus supports all Adobe Photoshop versions from CS3 to CC 2026, including both 32-bit and 64-bit systems." },
      ...
      { q: "Does Alplum Plus work on Mac?", a: "Currently, Alplum Plus is designed for Windows operating systems. Mac support is planned for future releases." },
    ],
  },
  {
    category: "License & Activation",
    questions: [
      { q: "How do I activate my license?", a: "After purchasing, you'll receive a license key (format: ALPM-XXXX-XXXX-XXXX). Go to the Activate License page, enter your key and device ID, and click Activate. Your license will be bound to that device." },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Is there a refund policy?", a: "Since Alplum Plus is a digital product, refunds are not available after purchase. We strongly recommend trying the free demo version before buying. See our Refund Policy page for details." },
  ...
  },
  {
    ...
    questions: [
      { q: "Alplum Plus is running slow. What should I do?", a: "Ensure your system meets minimum requirements (4GB RAM, dual-core processor). Close other heavy applications, and make sure you're running the latest version of Alplum Plus." },
...
const Support = () => {
  ...
  const waUrl = `https://api.whatsapp.com/send?phone=${supportPhone.replace(/\D/g, "")}&text=${encodeURIComponent("Hi AlplumPlus Team, I need help with ...")}`;
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <a href={`mailto:${settings.support_email || "support@alplumplus.in"}`} className="text-sm text-accent font-medium hover:underline">
                  {settings.support_email || "support@alplumplus.in"}
                </a>
              </motion.div>
